...
namespace Ofqual.Common.RegisterFrontend.RegisterAPI
{
    public interface IRegisterAPIClient
    {
        ...
        Task<APIResponseList<QualificationListViewModel>> GetQualificationsListAsync(string? title, int? page = null, int? limit = null, string? assessmentMethods = null, string? gradingTypes = null, [Query(CollectionFormat.Multi)] string[]? awardingOrganisations = null, string ? availability = null, string? qualificationTypes = null, string? qualificationLevels = null, string? nationalAvailability = null, string? sectorSubjectAreas = null, int? minTotalQualificationTime = null, int? maxTotalQualificationTime = null, int? minGuidedLearninghours = null, int? maxGuidedLearninghours = null);
